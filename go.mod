module github.com/Hexrotor/f2p
...
require (
	...
	github.com/mr-tron/base58 v1.2.0 // indirect; direct
...
replace github.com/libp2p/go-libp2p => github.com/Hexrotor/go-libp2p v0.0.0-20260216010903-6e7b69b3767d
